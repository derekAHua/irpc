...
type (
	...
	HashServiceAndArgs func(len int, options ...interface{}) int

	// ConsistentAddrStrFunction define a hash function.
	// Return service address, like "tcp@127.0.0.1:8970".
	ConsistentAddrStrFunction func(options ...interface{}) string
)
