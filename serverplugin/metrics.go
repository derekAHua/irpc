...
func (p *MetricsPlugin) Register(_ string, _ interface{}, _ string) error {
...
func (p *MetricsPlugin) PreReadRequest(_ context.Context) error {
	return nil
}

// PostReadRequest counts read
func (p *MetricsPlugin) PostReadRequest(_ context.Context, r *protocol.Message, _ error) error {
	sp := r.ServicePath
	sm := r.ServiceMethod
...
func (p *MetricsPlugin) PostWriteResponse(ctx context.Context, _ *protocol.Message, res *protocol.Message, _ error) error {
	sp := res.ServicePath
