...
func (p *AliasPlugin) PostReadRequest(_ context.Context, r *protocol.Message, _ error) error {
...
func (p *AliasPlugin) PreWriteResponse(_ context.Context, r *protocol.Message, res *protocol.Message) error {
