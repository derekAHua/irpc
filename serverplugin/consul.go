...
func (p *ConsulRegisterPlugin) Register(name string, _ interface{}, metadata string) (err error) {
...
func (p *ConsulRegisterPlugin) RegisterFunction(serviceName, _ string, fn interface{}, metadata string) error {
