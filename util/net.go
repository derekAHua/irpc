...
//// ParseIrpcAddress parses irpc address such as tcp@127.0.0.1:8972  quic@192.168.1.1:9981
//func ParseIrpcAddress(addr string) (network string, ip string, port int, err error) {
//	ati := strings.Index(addr, "@")
//	if ati <= 0 {
//		return "", "", 0, fmt.Errorf("invalid irpc address: %s", addr)
//	}
//
//	network = addr[:ati]
//	addr = addr[ati+1:]
